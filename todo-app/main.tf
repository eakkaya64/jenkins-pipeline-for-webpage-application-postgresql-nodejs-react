terraform {
  ...
  backend "s3" {
    bucket = "jenkins-project-backend-ertugrul" # ismi s3 oluşturduğuna göre değiştir
...
variable "user" {
  default = "ertugrul" # kendi ismini gir
}
...
resource "aws_instance" "managed_nodes" {
  ...
  key_name = "ertugrul"  # change with your pem file
